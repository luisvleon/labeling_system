...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbl_invoice SET status=%s WHERE invoice_id=%s",
                       GetSQLValueString($_POST['hidden_value'], "int"),
  ...
  $updateGoTo = "/labels/orden_list.php";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" -->
      ...
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">Cerrar factura</td>
        </tr>
      </table>
      <br />
      <br />
      <table width="390" border="0" align="center">
        <tr>
          <td align="center" class="cajagrande">Una vez que cierre la factura no podra agregar mas items a la misma. Desea hacer esto?</td>
        </tr>
      </table>
      <p>&nbsp;</p>
        ...
        <table width="200" border="0" align="center">
          <tr>
            <td align="center"><label>
              <input type="hidden" name="hidden_id" id="hidden_id" value="<?php echo $_REQUEST['inv_id']; ?>" />
              <input name="hidden_value" type="hidden" id="hidden_value" value="1" />
              <input type="submit" name="button" id="button" value="   Cerrar   " />
            </label></td>
          </tr>
        </table>
