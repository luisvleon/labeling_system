...
mysql_select_db($database_labels_con, $labels_con);
$query_Recordset2 = "SELECT * FROM tbl_costumers ORDER BY cos_names ASC";
  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" -->
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">Lista de clientes</td>
        </tr>
      </table>
      <br />
      <table width="963" border="1" align="center">
        <tr bgcolor="#333333">
          <td width="185"><strong class="cabecera">Cliente</strong></td>
          <td width="331"><strong class="cabecera">Razon social</strong></td>
          <td width="160"><strong class="cabecera">Ruc</strong></td>
          <td width="163"><strong class="cabecera">Telefono</strong></td>
          <td width="36"><strong class="cabecera">Editar</strong></td>
          <td width="48"><strong class="cabecera">Eliminar</strong></td>
        </tr>
        <?php if ($totalRows_Recordset2 > 0) { // Show if recordset not empty ?>
          <?php do { ?>
            <tr>
              <td><?php echo $row_Recordset2['cos_names']; ?></td>
              <td><?php echo $row_Recordset2['cos_corpname'] . " " .  $row_Recordset2['cos_corpname2']; ?></td>
              <td><?php echo $row_Recordset2['cos_ruc']; ?></td>
              <td><?php echo $row_Recordset2['cos_phone1']; ?></td>
              <td align="center"><a href="costu_edit.php?cos_id=<?php echo $row_Recordset2['cos_id']; ?>"><img src="editi.png" width="16" height="16" border="0" /></a></td>
