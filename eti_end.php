...
mysql_select_db($database_labels_con, $labels_con);
$query_invoice = sprintf("SELECT SUM(cantidad) total FROM tbl_order WHERE ord_status=0 and invoice_id = %s", GetSQLValueString($_COOKIE["inv_id"], "int"));
  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" -->
      ...
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">Creacion de etiquetas</td>
        </tr>
      </table>
      <br />
      <table width="600" border="0" align="center">
        <tr>
          <td align="center"><p>Total a imprimir: <span class="cajagrande"><?php echo $row_invoice['total']; ?></span></td>
        </tr>
      </table>
      <br />
      <table width="474" border="0" align="center">
        <tr>
          <td align="center">Su etiqueta ha sido creada exitosamente. Desea crear otra mas?</td>
        </tr>
      </table>
      <br />
      <table width="296" border="0" align="center">
        <tr>
          <td width="155" align="center"><a href="eti_ori.php">Crear nueva</a></td>
          <td width="131" align="center"><a href="orden_etiq.php">Ir a etiquetas.</a></td>
        </tr>
      </table>
      <p><br />
      </p>
