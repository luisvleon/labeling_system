...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbl_params SET par_label=%s WHERE par_id=%s",
...
if (isset($_GET['par_id'])) {
  $colname_Recordset2 = $_GET['par_id'];
}
mysql_select_db($database_labels_con, $labels_con);
$query_Recordset2 = sprintf("SELECT * FROM tbl_params WHERE par_id = %s", GetSQLValueString($colname_Recordset2, "int"));
  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" -->
      ...
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">Editar instrucción</td>
        </tr>
      </table>
      <br />
      <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
        <table width="532" border="1" align="center">
          <tr>
            <td width="103" bgcolor="#333333" class="cabecera">Instrucción:
            <input name="hiddenField" type="hidden" id="hiddenField" value="<?php echo $row_Recordset2['par_id']; ?>" /></td>
            <td width="351"><label>
              <input name="textfield" type="text" id="textfield" value="<?php echo $row_Recordset2['par_label']; ?>" size="50" maxlength="40" />
            </label></td>
            <td width="56"><label>
