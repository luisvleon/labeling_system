...
mysql_select_db($database_labels_con, $labels_con);
$query_ins = "SELECT * FROM tbl_params ORDER BY par_label ASC";
  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" -->
      ...
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">Listado de instrucciones de lavado</td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <table width="384" border="1" align="center">
        <tr bgcolor="#333333" class="cabecera">
          <td width="278">Instrucción:</td>
          <td width="36">Editar</td>
          <td width="48">Eliminar</td>
        </tr>
        <?php do { ?>
          <tr>
            <td><?php echo $row_ins['par_label']; ?></td>
            <td align="center"><a href="ins_edit.php?par_id=<?php echo $row_ins['par_id']; ?>"><img src="editi.png" width="16" height="16" border="0" /></a></td>
