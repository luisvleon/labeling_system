  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" --><br />
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">Eliminar item de invoice</td>
        </tr>
      </table>
      <br />
      <br />
      <table width="766" border="0" align="center">
        <tr>
          <td>Va a eliminar un item del invoice # <?php echo $_REQUEST['invoice_id']; ?> de <?php echo $_REQUEST['cliente']; ?> , si es asi de click en el boton enviar o regrese a la pagina anterior.</td>
        </tr>
      </table>
      <br />
        ...
        <table width="200" border="0" align="center">
          <tr>
            <td align="center"><label>
              ...
              <input type="hidden" name="hidden_invid" id="hidden_invid" value="<?php echo $_REQUEST['inv_id']; ?>" />
              <input type="submit" name="button" id="button" value="    eliminar item    " />
            </label></td>
          </tr>
        </table>
      </form>
