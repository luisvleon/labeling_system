...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbl_marcas (marca_text, cos_id) VALUES (%s, %s)",
...
mysql_select_db($database_labels_con, $labels_con);
$query_activo = "SELECT cos_id FROM tbl_invoice WHERE activo = 1";
$activo = mysql_query($query_activo, $labels_con) or die(mysql_error());
  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" --><br />
      ...
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">Agregar marcas</td>
        </tr>
      </table>
      <br />
      <br />
      <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
        <table width="479" border="1" align="center">
          <tr>
            <td width="67" bgcolor="#333333" class="cabecera">Marca
            <input name="hidden_cos" type="hidden" id="hidden_cos" value="<?php echo $row_activo['cos_id']; ?>" /></td>
            <td width="330"><label>
              <input name="textfield" type="text" id="textfield" size="50" maxlength="40" />
            </label></td>
            <td width="60"><label>
