...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbl_marcas SET marca_text=%s WHERE marca_id=%s",
...
if (isset($_GET['marca_id'])) {
  $colname_marca = $_GET['marca_id'];
}
mysql_select_db($database_labels_con, $labels_con);
$query_marca = sprintf("SELECT * FROM tbl_marcas WHERE marca_id = %s", GetSQLValueString($colname_marca, "int"));
$marca = mysql_query($query_marca, $labels_con) or die(mysql_error());
  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" --><br />
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">Editar marcas</td>
        </tr>
      </table>
      <br />
      <br />
      <form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
        <table width="479" border="1" align="center">
          <tr>
            <td width="67" bgcolor="#333333" class="cabecera">Marca</td>
            <td width="330"><label>
              <input name="textfield" type="text" id="textfield" value="<?php echo $row_marca['marca_text']; ?>" size="50" maxlength="40" />
              <input name="hiddenField" type="hidden" id="hiddenField" value="<?php echo $row_marca['marca_id']; ?>" />
            </label></td>
            <td width="60"><label>
