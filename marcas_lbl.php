...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO lbl_marcas (id_marca, cantidad) VALUES (%s, %s)",
  ...
  mysql_select_db($database_labels_con, $labels_con);
$query_maximo = "SELECT max(id) FROM lbl_marcas";
...
{ 
  $insertSQL = sprintf("INSERT INTO lbl_marcas_duplic (id, duplicados) VALUES (%s, %s)",
...
mysql_select_db($database_labels_con, $labels_con);
$query_tallas = "SELECT * FROM tbl_marcas ORDER BY marca_text ASC";
  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" -->
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">Etiquetas de marca</td>
        </tr>
      </table>
      <p>&nbsp;</p>
        ...
        <table width="600" height="125" border="0" align="center">
          <tr>
            <td><table width="393" border="1" align="center">
              <tr>
                <td width="141" bgcolor="#333333" class="cabecera">Seleccione la marca : </td>
                <td width="242"><label>
                  <select name="select_talla" id="select_talla">
                    <?php
do {  
?>
                    <option value="<?php echo $row_tallas['marca_id']?>"><?php echo $row_tallas['marca_text']?></option>
                    <?php
