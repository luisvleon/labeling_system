...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbl_inv_simple SET invoice_id=%s WHERE box=%s AND invoice_id=%s",
                       GetSQLValueString($_POST['txt_inv2'], "int"),
                       GetSQLValueString($_POST['txt_box'], "int"),
                       GetSQLValueString($_POST['txt_inv1'], "int"));
          ...
          <td width="531" align="center" class="Titulo"><p>Update box</p>
            ...
            <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
              <table width="274" border="1">
                <tr>
                  <td width="150" bgcolor="#666666" class="cabecera">From invoice #</td>
                  <td width="108"><label for="txt_inv1"></label>
                  <input name="txt_inv1" type="text" class="cajagrande" id="txt_inv1" size="5" maxlength="2" /></td>
                </tr>
                <tr>
                  <td bgcolor="#666666" class="cabecera">To invoice #</td>
                  <td><input name="txt_inv2" type="text" class="cajagrande" id="txt_inv2" size="5" maxlength="2" /></td>
                </tr>
                <tr>
                  <td bgcolor="#666666" class="cabecera">Box#</td>
                  <td><input name="txt_box" type="text" class="cajagrande" id="txt_box" size="5" maxlength="2" /></td>
                </tr>
                <tr>
