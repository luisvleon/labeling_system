...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbl_inv_simple SET box=%s WHERE box=%s AND invoice_id=%s",
                       GetSQLValueString($_POST['txt_box_to'], "int"),
                       GetSQLValueString($_POST['txt_box_from'], "int"),
                       GetSQLValueString($_POST['txt_inv'], "int"));
  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" -->
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo"><p>Update box</p>
            <p>&nbsp;</p>
            <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
              <table width="274" border="1">
                <tr>
                  <td width="150" bgcolor="#666666" class="cabecera">nvoice #</td>
                  <td width="108"><label for="txt_inv1"></label>
                  <input name="txt_inv" type="text" class="cajagrande" id="txt_inv1" size="5" maxlength="2" /></td>
                </tr>
                <tr>
                  <td bgcolor="#666666" class="cabecera">Box from</td>
                  <td><input name="txt_box_from" type="text" class="cajagrande" id="txt_inv2" size="5" maxlength="2" /></td>
                </tr>
                <tr>
                  <td bgcolor="#666666" class="cabecera">Box to:</td>
                  <td><input name="txt_box_to" type="text" class="cajagrande" id="txt_box" size="5" maxlength="2" /></td>
                </tr>
                <tr>
                  <td bgcolor="#666666" class="cabecera">&nbsp;</td>
