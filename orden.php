...
mysql_select_db($database_labels_con, $labels_con);
$query_clientes = "SELECT cos_id, cos_names, cos_corpname, cos_ruc FROM tbl_costumers ORDER BY cos_names ASC";
$clientes = mysql_query($query_clientes, $labels_con) or die(mysql_error());
  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" -->
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">Creacion de ordenes de trabajo e invoice</td>
        </tr>
      </table>
      <br />
      <table width="518" border="0" align="center">
        <tr>
          <td align="center">Por favor seleccione al cliente para la orden de trabajo.</td>
        </tr>
      </table>
      <br />
      <br />
      <table width="714" border="1" align="center">
        <tr bgcolor="#333333" class="cabecera">
          <td width="144">Cliente</td>
          <td width="330">Razon Social</td>
          <td width="166">Ruc</td>
          <td width="46">Sel</td>
        </tr>
        <?php do { ?>
          <tr>
            <td><?php echo $row_clientes['cos_names']; ?></td>
            <td><?php echo $row_clientes['cos_corpname']; ?></td>
            <td><?php echo $row_clientes['cos_ruc']; ?></td>
            <td align="center"><a href="orden_ship.php?cos_id=<?php echo $row_clientes['cos_id']; ?>"><img src="detalle.png" width="16" height="16" border="0" /></a></td>
          </tr>
