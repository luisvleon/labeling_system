...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbl_origin SET ori_name=%s WHERE ori_id=%s",
...
if (isset($_GET['ori_id'])) {
  $colname_Recordset2 = $_GET['ori_id'];
}
mysql_select_db($database_labels_con, $labels_con);
$query_Recordset2 = sprintf("SELECT * FROM tbl_origin WHERE ori_id = %s", GetSQLValueString($colname_Recordset2, "int"));
  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" --><br />
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">Editar origen</td>
        </tr>
      </table>
      <p><br />
      </p>
      <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
        <table width="397" border="1" align="center">
          <tr>
            <td width="54" bgcolor="#333333" class="cabecera">Origen:</td>
            <td width="282"><label>
              <input name="textfield" type="text" id="textfield" value="<?php echo $row_Recordset2['ori_name']; ?>" size="30" maxlength="20" />
              <input name="hiddenField" type="hidden" id="hiddenField" value="<?php echo $row_Recordset2['ori_id']; ?>" />
            </label></td>
            <td width="39"><label>
