...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbl_order SET ord_status=%s WHERE invoice_id=%s",
                       "1", GetSQLValueString($_REQUEST['id'], "int"));

  mysql_select_db($database_labels_con, $labels_con);
  $Result1 = mysql_query($updateSQL, $labels_con) or die(mysql_error());

  $updateGoTo = "orden_etiq.php?id=2";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" -->
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">Resetear impresion de etiquetas</td>
        </tr>
      </table>
      <br />
      <table width="491" border="0" align="center">
        <tr>
          <td height="66" align="center">Esta Ud seguro que desea resetear la impresion de etiquetas? </td>
        </tr>
        <tr>
