...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbl_sizes (size_text, size_label) VALUES (%s, %s)",
  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" -->
      ...
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">Agregar medidas</td>
        </tr>
      </table>
      <br />
      <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
        ...
        <table width="328" border="1" align="center">
          <tr>
            <td width="92" bgcolor="#333333" class="cabecera">Inicial:</td>
            <td width="220"><label>
              <input name="textfield" type="text" id="textfield" size="14" maxlength="6" />
            </label></td>
          </tr>
          <tr>
            <td bgcolor="#333333" class="cabecera">Medida:</td>
            <td><label>
              <input name="textfield2" type="text" id="textfield2" size="30" maxlength="20" />
            </label></td>
          </tr>
          <tr>
