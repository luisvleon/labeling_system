...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbl_sizes SET size_text=%s, size_label=%s WHERE size_id=%s",
  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" -->
      ...
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">Editar medida</td>
        </tr>
      </table>
      <p><br />
      </p>
      <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
        <table width="316" border="1" align="center">
          <tr>
            <td width="96" bgcolor="#333333" class="cabecera">Inicial:
            <input name="hiddenField" type="hidden" id="hiddenField" value="<?php echo $row_medidas['size_id']; ?>" /></td>
            <td width="204"><label>
              <input name="textfield" type="text" id="textfield" value="<?php echo $row_medidas['size_text']; ?>" size="10" maxlength="3" />
            </label></td>
          </tr>
          <tr>
            <td bgcolor="#333333" class="cabecera">Medida:</td>
            <td><label>
              <input name="textfield2" type="text" id="textfield2" value="<?php echo $row_medidas['size_label']; ?>" size="30" maxlength="20" />
            </label></td>
          </tr>
          <tr>
