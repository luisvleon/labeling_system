...
mysql_select_db($database_labels_con, $labels_con);
$query_Recordset2 = "SELECT * FROM tbl_sizes ORDER BY size_text DESC";
  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" -->
      ...
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">Listado de medidas</td>
        </tr>
      </table>
      <br />
      <table width="342" border="0" align="center">
        <tr>
          <td width="155" align="center"><a href="/labels/size_lbl.php">Generar etiquetas de talla</a></td>
          <td width="104" align="center"><a href="/labels/size_reset.php">Reset</a></td>
        </tr>
      </table>
      <br />
      <table width="524" border="1" align="center">
        <tr bgcolor="#333333" class="cabecera">
          <td width="141">Inicial</td>
          <td width="322">Medida</td>
          <td width="39">Editar</td>
        </tr>
        <?php do { ?>
          <tr>
            <td><?php echo $row_Recordset2['size_text']; ?></td>
            <td><?php echo $row_Recordset2['size_label']; ?></td>
            <td align="center"><a href="size_edit.php?size_id=<?php echo $row_Recordset2['size_id']; ?>"><img src="editi.png" width="16" height="16" border="0" /></a></td>
          </tr>
