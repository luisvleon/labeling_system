...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE lbl_tallas SET status=%s", GetSQLValueString($_POST['hiddenField'], "int"));

  mysql_select_db($database_labels_con, $labels_con);
  $Result1 = mysql_query($updateSQL, $labels_con) or die(mysql_error());

  $updateGoTo = "/labels/size_list.php";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" -->
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">Vaciar tabla de tallas</td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
        <table width="200" border="0" align="center">
          <tr>
            <td align="center"><p>Desea resetear la tabla de etiquetas de tallas?</p>
              <p>
