  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" -->
      ...
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">Agregar materiales</td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
        <table width="433" border="1" align="center">
          <tr>
            <td bgcolor="#333333" class="cabecera">Material:</td>
            <td><label>
              <input name="textfield" type="text" id="textfield" size="30" maxlength="20" />
            </label></td>
            <td><label>
