...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbl_stuff SET stu_text=%s WHERE stu_id=%s",
...
if (isset($_GET['stu_id'])) {
  $colname_material = $_GET['stu_id'];
}
mysql_select_db($database_labels_con, $labels_con);
$query_material = sprintf("SELECT * FROM tbl_stuff WHERE stu_id = %s", GetSQLValueString($colname_material, "int"));
  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" -->
      ...
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">Editar material</td>
        </tr>
      </table>
      <p><br />
      </p>
      <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
        <table width="433" border="1" align="center">
          <tr>
            <td bgcolor="#333333" class="cabecera">Material:
            <input name="hiddenField" type="hidden" id="hiddenField" value="<?php echo $row_material['stu_id']; ?>" /></td>
            <td><label>
              <input name="textfield" type="text" id="textfield" value="<?php echo $row_material['stu_text']; ?>" size="30" maxlength="20" />
            </label></td>
            <td><label>
