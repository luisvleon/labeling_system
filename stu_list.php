  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" --><br />
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">Listado de materiales</td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <table width="236" border="1" align="center">
        <tr bgcolor="#333333" class="cabecera">
          <td width="106" align="center">Material</td>
          <td width="114" align="center">Editar</td>
        </tr>
        <?php do { ?>
          <tr>
            <td><?php echo $row_materiales['stu_text']; ?></td>
            <td align="center"><a href="stu_edit.php?stu_id=<?php echo $row_materiales['stu_id']; ?>"><img src="editi.png" width="16" height="16" border="0" /></a></td>
          </tr>
