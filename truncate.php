...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbl_order SET ord_status=1");
  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" -->
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">TRUNCATE LABELS</td>
        </tr>
      </table>
      <br />
      <br />
      ...
      <table width="600" border="0" align="center">
        <tr>
          <td align="center">Esta Ud seguro que desea marcar todas las etiquetas como impresas?</td>
        </tr>
      </table>
      <br />
