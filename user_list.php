...
mysql_select_db($database_labels_con, $labels_con);
$query_usuarios = "SELECT * FROM tbl_users ORDER BY user_names ASC";
$usuarios = mysql_query($query_usuarios, $labels_con) or die(mysql_error());
  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" -->
      ...
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center" class="Titulo">Lista de usuarios</td>
        </tr>
      </table>
      <br />
      <table width="411" border="1" align="center">
        <tr bgcolor="#333333" class="cabecera">
          <td width="139">Nombres</td>
          <td width="158">Usuario</td>
          <td width="92" align="center">Editar</td>
        </tr>
        <?php do { ?>
          <tr>
            <td><?php echo $row_usuarios['user_names']; ?></td>
            <td><?php echo $row_usuarios['user_username']; ?></td>
            <td align="center"><img src="editi.png" alt="Editar usuario" width="16" height="16" border="0" /></td>
          </tr>
