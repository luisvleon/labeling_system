...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbl_users SET user_password=%s WHERE user_id=%s",
  ...
  <tr>
    <td width="814" height="652" valign="top"><!-- InstanceBeginEditable name="edit1" -->
      ...
      <table width="537" border="0" align="center">
        <tr>
          <td width="531" align="center"><p><span class="Titulo">Cambiar password de </span></p>
            <p><span class="Titulo"><br />
              </span><?php echo $row_Recordset1['user_names']; ?></p></td>
        </tr>
      </table>
      <br />
      <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
        <table width="511" border="1" align="center">
          <tr>
            <td bgcolor="#333333" class="cabecera">Nuevo password:
            <input name="hidden_id" type="hidden" id="hidden_id" value="<?php echo $row_Recordset1['user_id']; ?>" /></td>
            <td><label>
              <input name="txt_pass" type="password" id="txt_pass" size="30" maxlength="20" />
            </label></td>
            <td><label>
